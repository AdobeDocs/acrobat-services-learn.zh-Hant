...
1. 如果你還沒安裝 Java 8 或更高[&#128279;](https://www.oracle.com/java/technologies/javase-downloads.html)版本，建議安裝。
1. 跑去 `javac -version` 驗證你的安裝。
1. 確認 JDK bin 資料夾是否包含在 PATH 變數中（方法依作業系統而異）。
1. 如果你還沒安裝 Maven[&#128279;](https://maven.apache.org/install.html)，請用你偏好的工具安裝。
