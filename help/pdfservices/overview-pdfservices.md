---
title: Adobe PDF 服務 API 教學
description: Adobe PDF 服務 API 教學的概覽頁面
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="https://experienceleague.adobe.com/en/docs/events/adobe-developers-live-recordings/2021/oct2021/pdf-services-api" target="_self" rel="referrer" title="Adobe PDF 服務 API 簡介">Adobe PDF 服務 API 簡介</a>
                    </p>
                    <p class="is-size-6">Adobe 的 PDF 服務 API 讓開發者能透過強大且靈活的雲端 API 從 PDF 中建立、合併、匯出及擷取資料</p>
                </div>
