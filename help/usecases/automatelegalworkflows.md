...
1. 請點此[&#128279;](https://documentcloud.adobe.com/dc-integration-creation-app-cdn/main.html)註冊您的證件。
1. 用你的 Adobe ID 登入。
1. 設定你的憑證名稱。
...
想了解更多如何為 Acrobat Sign 建立授權令牌，你可以依照此[&#128279;](https://opensource.adobe.com/acrobat-sign/developer_guide/helloworld.html)處說明的步驟操作。
...
1. 將 agreementID **設**&#x200B;為&#x200B;*先前 API 呼叫提供的 agreementId*。
1. 選擇 **[!UICONTROL 「試試看！]**」。
