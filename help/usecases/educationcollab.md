...
在此實作教學課程中，學習建立一個在線學習平臺， [讓老師和學生能夠輕鬆地在 PDF 中共用資源](https://developer.adobe.com/document-services/use-cases/collaboration/student-teacher-collaboration) 。 本教學課程使用 [使用使用 Node.js JavaScript 執行時間 （Node.js） 和 PDF 服務建立的學習入口](https://github.com/afzaal-ahmad-zeeshan/adobe-pdf-tools-for-teachers) 網站。
...
免費使用 PDF Services API 6 個月及最多 1,000 筆檔交易。 之後，當班級開始作業時， [即用即付](https://developer.adobe.com/document-services/pricing/main) 每份檔交易只要 \$0.05。
