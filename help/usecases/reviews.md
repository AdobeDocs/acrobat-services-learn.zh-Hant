...
這個實作教學展示了 API 如何[!DNL Acrobat Services]將文件分享與審查工作流程](https://developer.adobe.com/document-services/use-cases/collaboration/review-and-approval)整合[進網頁應用程式。該應用程式允許遠端工作者分享檔案並與團隊成員協作，對於在家工作的員工和承包商尤其有幫助。
